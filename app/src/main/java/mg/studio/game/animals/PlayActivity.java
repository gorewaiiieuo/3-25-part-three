...
public class PlayActivity extends AppCompatActivity {
    ...
    private int arrayDrawableImagesBalckWhiteIDs[];
    private ImageButton arrayButtonViews[];
    private int score ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (ImageButton btnView : arrayButtonViews) {
            ...
            while (true) {
                indexOfWhatToUse = (int) (Math.random() * (arrayDrawableImagesIDs.length - 1));//0-17
    ...
    public void btnClick(View view) {
        ...
        if (animalToFind.equals(nameOfImagesUsed.get(Integer.valueOf(view.getTag().toString())))) {
            ...
            if(score < 7) {
                Toast.makeText(this, "congratulation! It is correct!", Toast.LENGTH_SHORT).show();
            ...
            //Todo 4 : Show a congratulating message if the user finishes all the challenges
                ...
                Toast.makeText(this, "awesome!You have finished!", Toast.LENGTH_SHORT).show();
                score = 0;
                Intent intent = new Intent(PlayActivity.this, MainActivity.class);
                startActivity(intent);
                PlayActivity.this.finish();
                System.out.println("awesome!You have finished!");
            }
        } else {
